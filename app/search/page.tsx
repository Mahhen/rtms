...
export default function TrainSearchResults() {
    ...
    const today = new Date(); // todo: use travel date
    ...
    useEffect(() => {
        (async () =>{
            if (paramData.from && paramData.to) {
                ...
                if (trainData) {
                    setTrains(trainData);
                    if (trainData.length > 0) setMasterDetail(trainData[0])
                }
                else setError(true);
                setLoading(false);
                        ...
                        <div className="grid gap-1 w-[500px]">
                            {trains.map((train) => (
                                <Card
                                    ...
                                    className={cn("rounded-[5px] border shadow-none hover:shadow-xl border-solid p-0 hover:cursor-pointer",
                                       masterDetail?.trainNumber === train.trainNumber ? "border-2 border-solid border-black" : "")}
                        ...
                        <div className="ml-5">
                            <Card className="rounded-sm shadow-none min-w-[500px] pb-0">
                                <CardContent className="relative">
                                    <div className="flex flex-row place-items-center">
                                        ...
                                        <ArrowRight className="h-4" color={"oklch(55.1% 0.027 264.364)"} />
                                        <div className="text-lg font-semibold">
                                    ...
                                    <div className="flex flex-row place-items-center">
                                        <div className="text-sm text-gray-700">
                                            {weekdays[today.getDay()]} {day}.{month}.{year}, {prettifiedDuration(masterDetail?.travelDuration)}
                                        </div>
                                    </div>
                                    <div className="mt-2 flex flex-row place-items-center w-full">
                                        <div className="text-sm font-semibold">
                            ...
                            <Card className="rounded-sm shadow-none py-4 my-2 hover:cursor-pointer hover:shadow-lg">
                                <div className="flex flex-row place-items-center w-full">
                                    <div className="ml-10">
                                        <MapPin className="h-4 w-4" color={"oklch(55.1% 0.027 264.364)"} />
                                    </div>
                            ...
                            <Card className="rounded-sm shadow-none py-4 my-2">
                                <div className="flex flex-col text-sm font-medium">
                                    <div className="flex items-center">
                                        <span className="w-12 text-right self-start">{masterDetail?.departureTime}</span>
                                    ...
                                    <div className="flex items-center">
                                        <span className="w-12 text-right">{masterDetail?.arrivalTime}</span>
